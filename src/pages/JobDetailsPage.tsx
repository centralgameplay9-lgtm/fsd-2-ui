  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
      ...
      <div className="flex items-center gap-2 text-sm text-slate-500 mb-6">
        ...
        <span>/</span>
        <span className="text-slate-900 dark:text-slate-100 font-medium truncate">{job.title}</span>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="card p-6">
            <h2 className="text-lg font-semibold mb-4">Recruiter Details</h2>
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500">{job.recruiter.title}</p>
                  ...
                  return (
                    <Link key={j.id} to={`/jobs/${j.id}`} className="flex items-start gap-3 group">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-slate-500">{c?.name} · {j.location}</p>
        ...
        {applyStep === 'form' ? (
          <form onSubmit={(e) => { e.preventDefault(); handleApply(); }} className="space-y-4">
            ...
            <div>
              ...
              <div className="border-2 border-dashed border-slate-200 dark:border-slate-700 rounded-lg p-4 text-center hover:border-primary-400 transition cursor-pointer">
          ...
          <div className="text-center py-6">
            ...
            <p className="text-sm text-slate-500 mt-2">Your application for {job.title} at {company?.name} has been sent. You'll be notified when there's an update.</p>
