      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden gradient-mesh py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              <h1 className="text-4xl sm:text-5xl font-bold text-balance">We're on a mission to connect<br /><span className="gradient-text">talent with opportunity</span></h1>
              <p className="mt-5 text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">HireHub was founded in 2024 with a simple goal: make hiring faster, fairer, and more human. Today, we're one of the fastest-growing job platforms in the world.</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 bg-slate-50 dark:bg-slate-900/50">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            <h2 className="text-3xl font-bold">Join the HireHub Community</h2>
            <p className="mt-2 text-slate-500">Whether you're hiring or looking, we'd love to have you.</p>
